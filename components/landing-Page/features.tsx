    ...
    <div className="w-full max-w-none flex flex-col justify-start items-center z-10 mx-auto">
      <div className="grid grid-cols-3 md:flex md:flex-wrap items-center justify-start gap-6 md:gap-8 w-[95%] mx-auto py-4">
        <motion.div
          ...
          onMouseEnter={() => handleMouseEnter("TailwndCSS")}
        ...
        >
          ...
          <motion.span
            animate={{
              scale: hoveredItem === "TailwndCSS" ? 1.1 : 1,
              fontWeight: hoveredItem === "TailwndCSS" ? 500 : 400,
            }}
        ...
        >
          {/* <Image
            ...
            height={32}
          /> */}
          <Motion className="w-8 h-8 text-yellow-500 dark:text-[#F5EA1E]" aria-label="Motion Logo" />
          <motion.span
            animate={{
        ...
        <motion.div
          ...
          onMouseEnter={() => handleMouseEnter("ShadcnUI")}
          onMouseLeave={handleMouseLeave}
        >
          <ShadcnIcon
          ...
          <motion.span
            animate={{
              scale: hoveredItem === "ShadcnUI" ? 1.1 : 1,
              fontWeight: hoveredItem === "ShadcnUI" ? 500 : 400,
            }}
