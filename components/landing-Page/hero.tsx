...
const hero = () => {
  return (
    <div className="mx-auto w-full max-w-7xl min-h-screen flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 px-4 sm:px-6 md:py-16 lg:py-20">
      {/* Left Section */}
      <div className="w-full lg:w-[55%] flex-col items-start text-left space-y-8">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
          <h1 className="text-xl sm:text-4xl lg:text-7xl font-bold tracking-light leading-[1.1] text-zinc-900 dark:text-zinc-100">
          ...
          <p className="mt-6 text-base md:text-xl text-zinc-700 dark:text-zinc-300 max-w-lg">
            Elevate your web projects with UI Perfect, the comprehensive React
            component library designed for developers and designers alike.
            Create beautiful, responsive interfaces with ease and speed
      ...
      {/* Right Section */}
      <div className="w-full lg:w-[45%] flex flex-col justify-between gap-6 lg:pl-8">
        {/*   Top Row card and Action Search Bar */}
        <motion.div
